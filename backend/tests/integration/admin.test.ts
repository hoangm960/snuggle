...
describe('Admin Routes', () => {
	...
	beforeEach(() => {
		app = createTestApp();
		adminToken = jwt.sign({ uid: 'admin-1', email: 'admin@example.com', role: 'admin' }, TEST_SECRET);
		userToken = jwt.sign({ uid: 'user-1', email: 'user@example.com', role: 'visitor' }, TEST_SECRET);
	});

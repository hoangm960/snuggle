...
export default function HeaderSection() {
  ...
  return (
    <>
      <header
        style={{ background: '#fff', borderBottom: '1px solid #E8E8E8', position: 'absolute', top: 0, left: 0, right: 0, zIndex: 20 }}
      ...
      >
        ...
        <nav className="hidden lg:flex items-center gap-7">
          {NAV_LINKS.map(link => (
            <a
              key={link}
              href={link === 'eKYC' ? '/ekyc' : `#${link.toLowerCase().replace(' ', '-')}`}
...
function PawLogo() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="27" viewBox="0 0 31 30" fill="none">
      ...
      <defs><clipPath id="paw_header"><rect width="31" height="30" fill="white"/></clipPath></defs>
    </svg>
  )
}
...
function SearchIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ flexShrink: 0 }}>
      ...
      <defs><clipPath id="s_header"><rect width="16" height="16" fill="white"/></clipPath></defs>
    </svg>
  )
}

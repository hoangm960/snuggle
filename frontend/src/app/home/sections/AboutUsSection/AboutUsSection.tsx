			...
			>
				...
				>
					...
					<p
						...
						style={{ color: "#3D2C1E", fontSize: "14px", maxWidth: "420px" }}
					>
						Snuggle is a data-driven pet adoption platform dedicated to creating perfect
						matches. By combining lifestyle algorithms with secure identity
						verification, we ensure every pet finds their true forever home. Find your

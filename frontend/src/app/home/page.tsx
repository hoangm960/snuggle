	...
	return (
		...
		>
			...
			<div style={{ position: "relative" }}>
				...
				>
					...
					>
						{/* Text side */}
						<div
							className="flex flex-col justify-center px-6 md:px-14 w-full lg:w-[52%]"
						...
						>
							...
							>
								Connecting loving families with pets who need a home. Browse, adopt,
			...
			>
				<div className="flex flex-col lg:flex-row items-center gap-10 max-w-6xl mx-auto">
					...
					<div className="flex-1 w-full" style={{ zIndex: 1 }}>
						...
						>
							Snuggle is a data-driven pet adoption platform dedicated to creating
							perfect matches. By combining lifestyle algorithms with secure identity
							verification, we ensure every pet finds their true forever home. Find
							your perfect animal soulmate.
						</p>
						<a
							href="#pets"
						...
						{TESTIMONIALS.concat([
							...
							<div key={t.name} className="flex flex-col gap-3">
								...
								<p
									...
									style={{ color: "#555", fontSize: "13px", marginTop: "-12px" }}
								>
									{t.text}
								</p>
								<div className="flex items-center gap-3 mt-2">
									...
									<div>
										...
										<div
											className="mt-0.5"
											style={{ color: "#7AADA1", fontSize: "11px" }}
										>
											{t.role}
										</div>
									</div>
			...
			<section
				id="contact"
				className="relative px-6 md:px-10 lg:px-20 py-16 md:py-24"
				style={{ background: "#6B4F3A", overflow: "hidden" }}
			>
				<img

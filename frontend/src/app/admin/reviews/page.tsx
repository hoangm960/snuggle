...
const mockReviews: Review[] = [
	{
		...
		rating: 5,
		comment:
			"The adoption process was smooth and the staff was incredibly helpful. Mochi has settled in perfectly!",
		date: "Apr 26, 2026",
		status: "published",
	},
	{
		id: "RV-002",
		reviewer: "David Kim",
		reviewerEmail: "david@email.com",
		petName: "Luna",
		shelter: "City Animal Rescue",
		rating: 4,
		comment:
			"Great experience overall. The shelter staff gave us all the information we needed. Luna is adjusting well.",
		date: "Apr 25, 2026",
		status: "published",
	},
	{
		id: "RV-003",
		reviewer: "Anonymous",
		reviewerEmail: "anon@email.com",
		petName: "Charlie",
		shelter: "Happy Paws Shelter",
		rating: 1,
		comment: "This shelter scammed me!!! Do not trust them.",
		date: "Apr 24, 2026",
		status: "flagged",
	},
	{
		...
		reviewerEmail: "james@email.com",
		petName: "Bella",
		shelter: "Furry Friends Hub",
		rating: 5,
		comment:
			"Wonderful experience. The team was professional and caring. Bella is the best thing that happened to our family.",
		date: "Apr 23, 2026",
		status: "published",
	},
	{
		id: "RV-005",
		reviewer: "Spam Account",
		reviewerEmail: "spam@fake.com",
		petName: "Max",
		shelter: "City Animal Rescue",
		rating: 1,
		comment: "Buy followers cheap at www.spam.com",
		date: "Apr 22, 2026",
		status: "removed",
	},
];
	...
	return (
		<AdminLayout>
				...
				<div className="flex items-center gap-3 mb-8">
					...
					<div>
						...
						<p style={{ color: "#888", fontSize: "13px" }}>
							Moderate adoption experience reviews
						</p>
					</div>
				</div>
					...
					<div className="flex gap-2">
						{(["all", "published", "flagged", "removed"] as const).map((tab) => (
							<button
								...
								style={{
									background: statusFilter === tab ? "#216959" : "#fff",
									color: statusFilter === tab ? "#fff" : "#666",
									border: "1px solid",
									borderColor: statusFilter === tab ? "#216959" : "#E8E8E8",
								}}
							>
								{tab}
							</button>
								...
								<div className="flex items-start justify-between gap-4">
									...
									<div className="flex items-center gap-1.5 shrink-0">
										<button
											...
											className="size-8 rounded-lg flex items-center justify-center hover:bg-gray-50 transition-colors"
										...
										{review.status === "published" && (
											<button
												...
												className="size-8 rounded-lg flex items-center justify-center hover:bg-orange-50 transition-colors"
												style={{ border: "1px solid #E8E8E8" }}
											>
												<Flag
													className="size-3.5"
										...
										{review.status === "flagged" && (
											<button
												...
												className="size-8 rounded-lg flex items-center justify-center hover:bg-green-50 transition-colors"
												style={{ border: "1px solid #E8E8E8" }}
											>
												<CheckCircle2
													className="size-3.5"
			...
			{selected && (
				...
				>
					<div
						className="w-[500px] rounded-2xl p-6"
					...
					>
						...
						<div className="p-4 rounded-xl mb-4" style={{ background: "#F9F6F2" }}>
							<div className="flex items-center gap-2 mb-3">
								...
								<div>
									<p style={{ fontWeight: 600, color: "#1C1C1C" }}>
										{selected.reviewer}
									</p>
						...
						{selected.status !== "removed" && (
							<div className="flex gap-3">
								{selected.status === "published" ? (
									<button
										onClick={() => setStatus(selected.id, "flagged")}

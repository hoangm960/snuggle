...
export default function EkycPage() {
	...
	function reject(id: string) {
		setSubmissions((prev) =>
			prev.map((s) => (s.id === id ? { ...s, status: "rejected", rejectReason } : s))
		);
		setRejectReason("");
		setSelected(null);
	}
	...
	return (
		<AdminLayout>
				...
				<div className="flex gap-2 mb-6">
					{(["all", "pending", "approved", "rejected"] as const).map((tab) => (
						<button
							...
							style={{
								background: filter === tab ? "#216959" : "#fff",
								color: filter === tab ? "#fff" : "#666",
								border: "1px solid",
								borderColor: filter === tab ? "#216959" : "#E8E8E8",
							}}
						>
			...
			{selected && (
				...
				>
					<div
						className="w-[560px] max-h-[85vh] overflow-y-auto rounded-2xl p-6"
					...
					>
						...
						<div className="grid grid-cols-3 gap-3 mb-6">
							{["ID Front", "ID Back", "Selfie"].map((label) => (
								<div
									...
									style={{ background: "#F9F6F2", border: "2px dashed #E0E0E0" }}
								>
						...
						{selected.rejectReason && (
							<div
								...
								style={{ background: "#FAF0EE", border: "1px solid #F0D8D4" }}
							>
								<p style={{ fontSize: "12px", fontWeight: 600, color: "#C4857A" }}>
							...
							<>
								...
								<div className="flex gap-3">
									<button
										...
										className="flex-1 py-2.5 rounded-xl font-medium text-sm transition-opacity hover:opacity-80"
									...
									<button
										...
										className="flex-1 py-2.5 rounded-xl font-medium text-sm text-white transition-opacity hover:opacity-90"
										style={{

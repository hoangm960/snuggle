...
const PETS = [
  {
    ...
    desc: 'A curious and independent tabby who loves to perch on high places and watch the world go by.',
    vaccinated: true,
    neutered: false,
  },
  {
    ...
    desc: 'A gentle giant who loves nothing more than a warm blanket and a quiet afternoon nap.',
    vaccinated: true,
    neutered: true,
  },
  {
    ...
    desc: 'Sweet and affectionate, Biscuit will happily curl up in your lap and purr you to sleep.',
    vaccinated: true,
    neutered: true,
  },
  {
    ...
    desc: 'Young and full of energy, Kiki loves to play and will keep you entertained for hours.',
    vaccinated: false,
    neutered: false,
  },
  {
    ...
    desc: 'Stylish and smart, Pepper is always dressed to impress and ready for a new adventure.',
    vaccinated: true,
    neutered: false,
  },
  {
    ...
    desc: 'A laid-back companion who appreciates a cozy spot and a loving home to call her own.',
    vaccinated: true,
    neutered: true,
  },
]
...
export default function PetsPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full" style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      {/* ── Header ── */}
      <header
        style={{ background: '#fff', borderBottom: '1px solid #E8E8E8', position: 'relative', zIndex: 20 }}
      ...
      >
        ...
        >
          <span style={{ display: 'block', width: '22px', height: '2px', background: '#333', borderRadius: '2px', transform: mobileMenuOpen ? 'translateY(6px) rotate(45deg)' : 'none', transition: 'transform 0.2s' }} />
          <span style={{ display: 'block', width: '22px', height: '2px', background: '#333', borderRadius: '2px', opacity: mobileMenuOpen ? 0 : 1, transition: 'opacity 0.2s' }} />
          <span style={{ display: 'block', width: '22px', height: '2px', background: '#333', borderRadius: '2px', transform: mobileMenuOpen ? 'translateY(-6px) rotate(-45deg)' : 'none', transition: 'transform 0.2s' }} />
        </button>
      </header>
        ...
        <div className="lg:hidden flex flex-col px-6 py-6 gap-5 bg-white border-b border-[#E8E8E8]" style={{ zIndex: 15 }}>
          {NAV_LINKS.map(link => (
            <Link
              ...
              style={{ color: link === 'Pets' ? '#7AADA1' : '#111', fontFamily: "'Space Grotesk', sans-serif", fontSize: '16px', fontWeight: link === 'Pets' ? 600 : 400 }}
            >
              {link}
            </Link>
          ))}
        ...
        >
          ...
          <div className="flex-1 w-full">
            ...
            <div className="flex items-center gap-2 mb-5">
              <Link href="/home" style={{ color: '#7AADA1', fontSize: '13px', fontFamily: "'Space Grotesk', sans-serif" }} className="hover:underline">
                Home
              </Link>
              <svg width="6" height="10" viewBox="0 0 6 10" fill="none">
                <path d="M1 1L5 5L1 9" stroke="#7AADA1" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <span style={{ color: '#7AADA1', fontSize: '13px', fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600 }}>Pets</span>
            </div>
            ...
            <h1
              style={{ color: '#3D2C1E', fontFamily: "'Space Grotesk', sans-serif", fontSize: 'clamp(30px, 4.5vw, 52px)', fontWeight: 700, lineHeight: 1.15 }}
              className="mb-5"
            >
              Meet Our<br />Adorable Pets
            </h1>
            <p className="mb-8" style={{ color: '#7A6055', fontSize: '15px', lineHeight: '1.8', maxWidth: '420px' }}>
              Browse our curated selection of loving companions waiting for their forever home. Every pet has been health-checked and is ready to snuggle.
            </p>
            ...
            <div className="flex gap-3 flex-wrap">
              <div
                ...
                style={{ padding: '12px 16px', borderRadius: '12px', background: '#fff', border: '1.5px solid #E8E8E8', minWidth: '200px' }}
              >
                <SearchIcon />
                <input
                  type="search"
              ...
              <button
                ...
                style={{ padding: '12px 28px', borderRadius: '12px', backgroundColor: '#7AADA1', color: '#fff', border: 'none', cursor: 'pointer', fontFamily: "'Space Grotesk', sans-serif", fontSize: '14px', whiteSpace: 'nowrap' }}
              >
                Find a Pet
              </button>
            </div>
            ...
            <div className="flex gap-6 mt-8 flex-wrap">
              {[
                { num: '6', label: 'Pets Available' },
                { num: '5', label: 'Cats' },
                { num: '1', label: 'Dog' },
              ].map(s => (
                <div key={s.label}>
                  <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: '22px', fontWeight: 700, color: '#3D2C1E' }}>{s.num}</span>
                  <span style={{ fontSize: '12px', color: '#7A6055', marginLeft: '6px' }}>{s.label}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Hero image */}
          <div className="flex-1 w-full flex justify-center lg:justify-end relative" style={{ minHeight: '320px' }}>
            ...
            <div
              style={{
                ...
                height: '340px',
                borderRadius: '50%',
                background: 'linear-gradient(135deg, rgba(122,173,161,0.20) 0%, rgba(33,105,89,0.12) 100%)',
                zIndex: 0,
              }}
            />
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              >
                <div style={{ width: '36px', height: '36px', borderRadius: '50%', background: '#E8F4F1', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  <PawIcon />
                </div>
                <div>
                  <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: '13px', fontWeight: 700, color: '#3D2C1E' }}>100% Verified</div>
                  <div style={{ fontSize: '11px', color: '#7A6055' }}>Health checked pets</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="px-6 md:px-10 lg:px-20 py-16 md:py-24" style={{ background: '#fff' }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
            <div>
              <p className="font-semibold mb-2 tracking-widest" style={{ color: '#7AADA1', fontSize: '11px', letterSpacing: '0.14em' }}>
                AVAILABLE NOW
              </p>
              <h2 className="font-bold" style={{ color: '#111', fontFamily: "'Space Grotesk', sans-serif", fontSize: 'clamp(22px, 3vw, 30px)' }}>
                Our Pets
              </h2>
            </div>
            ...
            <div className="flex gap-2">
              {([
                ...
                { key: 'cat', label: 'Cats', count: PETS.filter(p => p.type === 'cat').length },
                { key: 'dog', label: 'Dogs', count: PETS.filter(p => p.type === 'dog').length },
              ] as const).map(f => (
                <button
                  key={f.key}
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      padding: '1px 7px',
                      borderRadius: '10px',
                      background: activeFilter === f.key ? 'rgba(255,255,255,0.25)' : 'rgba(0,0,0,0.08)',
                      fontSize: '11px',
                      fontWeight: 700,
                    }}
                  >
          ...
          {filtered.length > 0 ? (
            ...
            <div className="flex flex-col items-center py-20 gap-4">
              <PawIcon />
              <p style={{ color: '#888', fontFamily: "'Space Grotesk', sans-serif", fontSize: '15px' }}>No pets found matching your search.</p>
              <button
                onClick={() => { setSearch(''); setActiveFilter('all') }}
                style={{ color: '#7AADA1', fontFamily: "'Space Grotesk', sans-serif", fontSize: '13px', background: 'none', border: 'none', cursor: 'pointer', textDecoration: 'underline' }}
              >
                Clear filters
              </button>
            </div>
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            <h2
              ...
              style={{ color: '#fff', fontFamily: "'Space Grotesk', sans-serif", fontSize: 'clamp(22px, 3vw, 32px)' }}
            >
              Ready to Adopt?
            </h2>
            <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '14px', lineHeight: '1.7', maxWidth: '420px' }}>
              Complete your eKYC verification to get matched with your perfect companion. It only takes 5 minutes.
            </p>
          </div>
          <div className="flex gap-4 flex-wrap">
            <Link
              href="/ekyc"
              className="flex items-center justify-center font-semibold hover:opacity-90 transition-opacity"
              style={{ padding: '13px 32px', borderRadius: '40px', background: '#fff', color: '#216959', fontFamily: "'Space Grotesk', sans-serif", fontSize: '14px', whiteSpace: 'nowrap' }}
            >
              Start eKYC
            </Link>
            <Link
              ...
              style={{ padding: '13px 32px', borderRadius: '40px', border: '1.5px solid rgba(255,255,255,0.6)', color: '#fff', fontFamily: "'Space Grotesk', sans-serif", fontSize: '14px', whiteSpace: 'nowrap' }}
            >
              Sign Up Free
            </Link>
          </div>
...
function PetCard({ pet }: { pet: typeof PETS[number] }) {
  ...
  return (
    ...
    >
      {/* Image */}
      <div className="relative w-full overflow-hidden" style={{ paddingTop: '72%', background: '#F9F6F2' }}>
        <img
          src={pet.img}
          alt={pet.name}
        ...
        <div
          ...
          style={{ background: 'rgba(255,255,255,0.95)', borderRadius: '20px', padding: '4px 12px', display: 'flex', alignItems: 'center', gap: '5px' }}
        >
          <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#22c55e', display: 'inline-block', flexShrink: 0 }} />
          <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: '11px', fontWeight: 600, color: '#166534' }}>Available</span>
        </div>
        {/* Type badge */}
        <div
          className="absolute top-4 left-4"
          style={{ background: pet.type === 'cat' ? '#E8F4F1' : '#FDF2F0', borderRadius: '20px', padding: '4px 12px' }}
        >
          <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: '11px', fontWeight: 600, color: pet.type === 'cat' ? '#216959' : '#C4857A' }}>
      ...
      <div className="flex flex-col flex-1 p-5">
        <div className="flex items-start justify-between mb-1">
          <h3 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: '18px', fontWeight: 700, color: '#1C1C1C' }}>{pet.name}</h3>
          <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: '12px', color: pet.gender === 'Female' ? '#C4857A' : '#7AADA1', fontWeight: 600 }}>
            {pet.gender === 'Female' ? '♀' : '♂'} {pet.gender}
          </span>
        </div>

        <p style={{ color: '#888', fontSize: '13px', marginBottom: '8px' }}>{pet.breed} · {pet.age}</p>

        <p style={{ color: '#666', fontSize: '12px', lineHeight: '1.6', marginBottom: '12px', flex: 1 }}>{pet.desc}</p>

        {/* Tags */}
        <div className="flex gap-2 flex-wrap mb-4">
          {pet.vaccinated && (
            <span style={{ padding: '3px 10px', borderRadius: '20px', background: '#E8F4F1', color: '#216959', fontSize: '11px', fontWeight: 600, fontFamily: "'Space Grotesk', sans-serif" }}>
              Vaccinated
            </span>
          )}
          {pet.neutered && (
            <span style={{ padding: '3px 10px', borderRadius: '20px', background: '#F9F6F2', color: '#7A6055', fontSize: '11px', fontWeight: 600, fontFamily: "'Space Grotesk', sans-serif" }}>
              Neutered
            </span>
          )}
        </div>
        ...
        <div className="flex items-center gap-1.5 mb-4">
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#7AADA1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" />
          </svg>
          <span style={{ fontSize: '12px', color: '#999', fontFamily: "'Space Grotesk', sans-serif" }}>{pet.location}</span>
        </div>

        <Link
          href="/register"
          className="block text-center font-semibold py-3 rounded-[40px] transition-all hover:opacity-90"
          style={{ background: '#7AADA1', color: '#fff', fontFamily: "'Space Grotesk', sans-serif", fontSize: '13px' }}
        >
          Adopt Me
        </Link>
      </div>
...
function PawLogo() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="27" viewBox="0 0 31 30" fill="none">
      ...
      <defs><clipPath id="paw_pets"><rect width="31" height="30" fill="white" /></clipPath></defs>
    </svg>
  )
}
...
function SearchIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ flexShrink: 0 }}>
      ...
      <defs><clipPath id="s_pets"><rect width="16" height="16" fill="white" /></clipPath></defs>
    </svg>
  )
}
